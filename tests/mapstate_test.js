...
(function() {
  ...
  this.errorHandler.logError('🧪 Testing MapState class...', 'function');

  // Create MapState instance
  const mapState = new global.window.MapState(global.window.MP4Config);

  // Test 1: Basic initialization
  this.errorHandler.logError('✅ Test 1: Basic initialization', 'function');
  ...
  this.errorHandler.logError('✅ Test 2: Canvas size setting', 'function');
  ...
  this.errorHandler.logError('✅ Test 3: Coordinate transformations', 'function');
  ...
  this.errorHandler.logError('✅ Test 4: Zoom functionality', 'function');
  ...
  this.errorHandler.logError('✅ Test 5: Pan functionality', 'function');
  ...
  this.errorHandler.logError('✅ Test 6: Bounds checking', 'function');
  ...
  this.errorHandler.logError('🎉 All MapState tests completed successfully!', 'function');
})();